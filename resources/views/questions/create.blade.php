    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action = "{{route('questions.store')}}" method ="post">
                ...
                <div class = "form-group">
                    <label for = "question-body">Explain Questions</label>
                    <textarea type = "text" name = "body" id = "question-body" rows = "10" class = "form-control {{$errors->has('body') ? 'is-invalid' : ''}}">{{old('body')}}</textarea>
                    @if($errors->has('body'))
